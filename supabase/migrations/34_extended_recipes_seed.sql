...
'["2 aubergines, in blokjes", "2 courgettes, in blokjes", "2 rode paprika\'s, in reepjes", "2 uien, in ringen", "4 tomaten, ontveld en in blokjes", "4 teentjes knoflook, fijngehakt", "4 eetlepels olijfolie", "1 takje rozemarijn", "2 takjes tijm", "Basilicum, fijngehakt", "Zout en peper"]'::jsonb,
...
'["200g rijstnoedels", "300g garnalen, gepeld", "2 eieren", "100g taugé", "4 lente-uien, in stukjes", "2 teentjes knoflook, fijngehakt", "50g pinda\'s, fijngehakt", "2 eetlepels vissaus", "2 eetlepels tamarindepasta", "2 eetlepels palmsuiker", "1 theelepel chilivlokken", "2 eetlepels olie", "Limoensap", "Koriander, fijngehakt"]'::jsonb,
'["Week de noedels 30 minuten in warm water tot zacht. Giet af.", "Meng vissaus, tamarinde, palmsuiker en chilivlokken voor de saus.", "Verhit olie in een wok. Bak knoflook 30 seconden. Voeg garnalen toe en bak 2 minuten.", "Schuif garnalen opzij. Klop eieren in de wok en roerbak tot gestold.", "Voeg noedels en saus toe. Roerbak 2 minuten tot noedels zacht zijn.", "Voeg taugé en lente-ui toe. Roerbak 1 minuut.", "Serveer met pinda\'s, koriander en limoensap."]'::jsonb,
